    ...
    public class RolesController
    {
        ...
        public (bool exito, string mensaje) CrearRolConPermisos(Rol rol, List<int> permisosIds)
        {
            try
            {
                ...
                _auditoriasController.RegistrarAuditoriaGenerica(4,1, (short)idRol, LoggingManager.UsuarioActual.Id_Usuario);
        ...
        public (bool exito, string mensaje) ActualizarRolConPermisos(Rol rol, List<int> nuevosPermisos)
        {
            try
            {
                ...
                _auditoriasController.RegistrarAuditoriaGenerica(4, 3, (short)rol.Id_Rol, LoggingManager.UsuarioActual.Id_Usuario);
        ...
        /// <returns></returns>
        public (bool exito, string mensaje) EliminarRol(int idRol, int idUsuario)
        {
            try
            {
                ...
                auditoriasController.RegistrarAuditoriaGenerica(4, 2, (short)idRol, idUsuario); // 4 = módulo Roles, 2 = Acción Eliminar
        ...
        public (bool exito, string mensaje) ExportarRolesExcel()
        {
            try
            {
                ...
                if (roles == null || roles.Count == 0)
                {
                    ...
                    return (false, "No se encontraron roles para exportar.");
                }
