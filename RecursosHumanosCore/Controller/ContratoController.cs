...
namespace RecursosHumanosCore.Controller
{
     public class ContratoController
    {
        ...
        //registrar un nuevo contrato
        public (int id, string mensaje) RegistrarContrato(string matricula, Contrato contrato, int idUsuario)

        {
            try
            {
                ...
                auditoriasController.RegistrarAuditoriaGenerica(2, 1, (short)idContrato, idUsuario);
                // 2 = Contrato, 1 = Alta
     ...
     DateTime? fechaFin)
        ...
        public (bool exito, string mensaje) ActualizarContrato(Contrato contrato, int idUsuario)

        {
            try
            {
                ...
                AuditoriasController auditoriasController = new AuditoriasController();
                auditoriasController.RegistrarAuditoriaGenerica(2, 2, (short)contrato.Id_Contrato, idUsuario);
                // 2 = Contrato, 3 = Actualización
