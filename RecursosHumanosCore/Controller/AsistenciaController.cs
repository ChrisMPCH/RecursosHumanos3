    ...
    public class AsistenciaController
    {
        ...
        public bool RegistrarEntrada(string matricula, out string mensaje)
        {
            ...
            if (!ValidarToleranciaEntrada(horaEsperada, horaReal))
            {
                ...
                bool ausenciaRegistrada = _ausenciasController.RegistrarAusenciaPorRetardo(empleado.Id_Empleado, LoggingManager.UsuarioActual.Id_Usuario, DateTime.Today, out string mensajeAusencia);
            ...
            if (resultado)
            {
                _auditoriasController.RegistrarAuditoriaGenerica(6, 1, (short)empleado.Id_Empleado, LoggingManager.UsuarioActual.Id_Usuario);
        ...
        public bool RegistrarSalida(string matricula, out string mensaje, string observaciones = "")
        {
            ...
            if (resultado)
            {
                _auditoriasController.RegistrarAuditoriaGenerica(6, 2, (short)empleado.Id_Empleado, LoggingManager.UsuarioActual.Id_Usuario);
