namespace RecursosHumanos.View
{
    partial class frmListaAsistencias
    {
        ...
        private void InitializeComponent()
        {
            ...
            lblTitulo.Text = "Listado de Asistencias";
            ...
            pnlTabla.Controls.Add(dgvAsistencias);
            pnlTabla.CustomizableEdges = customizableEdges7;
            pnlTabla.Location = new Point(12, 144);
            pnlTabla.Name = "pnlTabla";
            pnlTabla.ShadowDecoration.CustomizableEdges = customizableEdges8;
            ...
            dgvAsistencias.AlternatingRowsDefaultCellStyle = dataGridViewCellStyle1;
            ...
            dgvAsistencias.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle2;
            dgvAsistencias.ColumnHeadersHeight = 15;
            dgvAsistencias.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.EnableResizing;
            ...
            dgvAsistencias.DefaultCellStyle = dataGridViewCellStyle3;
            dgvAsistencias.Dock = DockStyle.Fill;
            dgvAsistencias.GridColor = Color.FromArgb(231, 229, 255);
            ...
            dgvAsistencias.Size = new Size(985, 585);
            dgvAsistencias.TabIndex = 1;
            dgvAsistencias.ThemeStyle.AlternatingRowsStyle.BackColor = Color.White;
            dgvAsistencias.ThemeStyle.AlternatingRowsStyle.Font = null;
            dgvAsistencias.ThemeStyle.AlternatingRowsStyle.ForeColor = Color.Empty;
            dgvAsistencias.ThemeStyle.AlternatingRowsStyle.SelectionBackColor = Color.Empty;
            dgvAsistencias.ThemeStyle.AlternatingRowsStyle.SelectionForeColor = Color.Empty;
            dgvAsistencias.ThemeStyle.BackColor = Color.White;
            dgvAsistencias.ThemeStyle.GridColor = Color.FromArgb(231, 229, 255);
            dgvAsistencias.ThemeStyle.HeaderStyle.BackColor = Color.FromArgb(100, 88, 255);
            dgvAsistencias.ThemeStyle.HeaderStyle.BorderStyle = DataGridViewHeaderBorderStyle.None;
            dgvAsistencias.ThemeStyle.HeaderStyle.Font = new Font("Microsoft Sans Serif", 8.25F);
            dgvAsistencias.ThemeStyle.HeaderStyle.ForeColor = Color.White;
            dgvAsistencias.ThemeStyle.HeaderStyle.HeaightSizeMode = DataGridViewColumnHeadersHeightSizeMode.EnableResizing;
            dgvAsistencias.ThemeStyle.HeaderStyle.Height = 15;
            dgvAsistencias.ThemeStyle.ReadOnly = true;
            dgvAsistencias.ThemeStyle.RowsStyle.BackColor = Color.White;
            dgvAsistencias.ThemeStyle.RowsStyle.BorderStyle = DataGridViewCellBorderStyle.SingleHorizontal;
            dgvAsistencias.ThemeStyle.RowsStyle.Font = new Font("Microsoft Sans Serif", 8.25F);
            dgvAsistencias.ThemeStyle.RowsStyle.ForeColor = Color.FromArgb(71, 69, 94);
            dgvAsistencias.ThemeStyle.RowsStyle.Height = 25;
            dgvAsistencias.ThemeStyle.RowsStyle.SelectionBackColor = Color.FromArgb(231, 229, 255);
            dgvAsistencias.ThemeStyle.RowsStyle.SelectionForeColor = Color.FromArgb(71, 69, 94);
            // 
            // pnlInfoUsuario
            // 
